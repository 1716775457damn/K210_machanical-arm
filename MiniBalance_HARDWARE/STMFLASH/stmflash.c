...
{
Flash_Parameter[0]=Balance_Kp*100;	//放大100存储，避免出现浮点数	
Flash_Parameter[1]=Balance_Kd*100;	//放大100存储，避免出现浮点数	
Flash_Parameter[2]=Velocity_Kp*100;	//放大100存储，避免出现浮点数	
Flash_Parameter[3]=Velocity_Ki*100;	//放大100存储，避免出现浮点数	
