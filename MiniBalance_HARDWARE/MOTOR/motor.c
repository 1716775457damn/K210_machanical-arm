...
{		 			
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_6|GPIO_Pin_7|GPIO_Pin_8|GPIO_Pin_9; //PB 6 7 8 9
...
//	TIM_Cmd(TIM1, ENABLE);  //使能TIM1
	...
	GPIOA->CRH&=0XFFFFFFF0;    //PA 8 11复用输出
	GPIOA->CRH|=0X0000000B;    //PA 8 11复用输出
...
void Time2_pwm_init()
{
	  ...
	  TIM2->CCER|=1<<8;         //CH4输出使能	   
	  TIM2->CCER|=1<<4;          //CH1输出使能	
...
void output_pwm(u8 chnl,float duty)
{
	...
	switch(chnl)
	{
		...
		case 1: TIM2->CCR1=count; break;
		case 2: TIM2->CCR2=count; break;
		case 3: TIM2->CCR3=count; break;
		case 4: TIM2->CCR4=count; break;
